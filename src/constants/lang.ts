export const TEXT: { [key: string]: { [key: string]: string } } = {
    ...
    'en': {
        ...
        'motherhood_cap': `Honest reflections on the growth, learning, and everyday moments of motherhood`,
        'inspiration': `INSPIRATION`,
        'inspiration_cap': `Inspiring stories about personal growth, inner strength, and living with intention and awarenes`,
        'see_all': `SEE ALL`,
        'mentoring': `MENTORING`,
        ...
        'life_abroad_cap': `Insightful stories of self-discovery, cultural adaptation, and expat life in foreign countries`,
        'shop': 'SHOP',
